...
filename1 = r'C:/Users/laleu/OneDrive/Documents/2A/DUST-CFD/Casalino/Hover_LL_3_donnees_Boqiao/Hover_LL_3_tableau1/resultats_5000RPM/TUD_blade1_Mo.dat'
filename2 = r'C:/Users/laleu/OneDrive/Documents/2A/DUST-CFD/Casalino/Hover_LL_3_donnees_Boqiao/Hover_LL_3_tableau1/resultats_5000RPM/TUD_blade2_Mo.dat'
...
results_blade2 = results_blade2[-15 % len(results_blade2):] + results_blade2[:-15 % len(results_blade2)]
...
axs[0].set_title("Moment des hélices 1 et 2 en fonction du temps (5000 RPM)", fontsize=14)
...
axs[1].plot(temps, results, marker='o', linestyle='-', color='g', label='Moment total')
axs[1].set_xlabel("Temps (s)", fontsize=12)
axs[1].set_ylabel("Fz (Nm)", fontsize=12)
axs[1].legend()
axs[1].grid(True)
